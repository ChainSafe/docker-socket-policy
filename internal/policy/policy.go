...
// Policy represents a service's Docker access policy.
type Policy struct {
...
// ContainerConfig represents enforced container options.
...
// Volume represents a whitelisted volume mount.
type Volume struct {
...
// FlagRule represents validation rules for a specific CLI flag.
